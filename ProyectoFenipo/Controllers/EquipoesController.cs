...
namespace ProyectoFenipo.Controllers
{
    public class EquipoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,NombreEquipo,NacionalidadEquipo")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NombreEquipo,NacionalidadEquipo")] Equipo equipo)
        {
            if (ModelState.IsValid)
            {
